...
class Case:
    ...
    def set_spectre(self):
        spectre = Spectre(self.estPlastique,0.2,1,10)   # si self.isPlastic vaut True, le constructeur de Spectre devra créer un objet Spectre contenant du plastique, sinon, un objet Spectre ne contenant pas de plastique
