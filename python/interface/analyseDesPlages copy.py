...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle("Projet Sandy")
        self.initDescription()
        self.initTitre()
        self.initNomPlage()
        self.initPollutionPlage()
        self.initPlage()
        self.initSpectre()
        self.setLabels()
    ...
    def initDescription(self):
        ...
        self.descriptionPlastique.setText("Description du plastique")
    ...
    def initTitre(self):
        ...
        self.Titre.setText("<html><head/><body><p><span style=\" color:#00007f;\">Analyse des plages</span></p></body></html>")

    def initNomPlage(self):
        ...
        self.nomPlage.setText("Nom de la plage:")
        
    
    def initPollutionPlage(self):
        ...
        self.pollutionPlage.setText("Pollution de la plage:")
